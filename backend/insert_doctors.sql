...
-- Generated on: 2025-11-05 11:57:25
...
VALUES (
    ...
    '555-0101',
    '$2b$12$pCSo5wKeda.UMcxxMDtjJOdvr5F3K90P/JTzKFTjfObhtuJiZzDHW',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0102',
    '$2b$12$1sYUyBFsLEjU8FzeksF3WeRlaR9S.ByuSMAXjD0hX68/YzgUo9rZe',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0103',
    '$2b$12$0x5AgyfFZXNMI5K7D6/fbu3SNdHA4lNe/fVVZRsOfyfaf.l/xI7i2',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0104',
    '$2b$12$0OeC2jnwl8lO2lAQiGSID.WMgUykEbmUk4NvJiJw7AOblfuAVoyiq',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0105',
    '$2b$12$TidoPw90Im8EEiV4EAOOguW1OdlFlf3fRq5Rgr2MozmN/XVXZsd6e',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0106',
    '$2b$12$9djs4sgFeQPu71zmppmo..XTVRVbMqiT/f3b8qhfpCy8a11IgGW3y',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0107',
    '$2b$12$Nqeo0omRPwU5/ukSO7ZiDuYyqhMLhifKEwbAo2tkEEAcH9qyHZ/iq',
    FALSE,
    'doctor',
    TRUE,
    NOW()
...
VALUES (
    ...
    '555-0108',
    '$2b$12$qoemeaejWNch39C55glwieJKd3oDa0GWoCVW0YMfIYWBNN6E5ckBm',
    FALSE,
    'doctor',
    TRUE,
    NOW()
